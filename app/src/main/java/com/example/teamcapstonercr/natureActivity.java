...
public class natureActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        player = MediaPlayer.create(natureActivity.this,R.raw.nature);
        ...
        volume.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onStartTrackingTouch(SeekBar seekBar) {
                Toast.makeText(natureActivity.this,"SeekBar in StartTracking",Toast.LENGTH_LONG).show();
            }

            @Override
            public void onStopTrackingTouch(SeekBar seekBar) {
                Toast.makeText(natureActivity.this,"SeekBar in StopTracking",Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    public void clickable(View v){
        Intent in = new Intent(natureActivity.this, SoundTypes.class);
        startActivity(in);
    }
}
