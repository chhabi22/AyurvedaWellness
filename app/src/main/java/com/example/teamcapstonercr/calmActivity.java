...
public class calmActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        player = MediaPlayer.create(calmActivity.this, R.raw.calm);
        ...
        volume.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onStartTrackingTouch(SeekBar seekBar) {
                Toast.makeText(calmActivity.this, "SeekBar in StartTracking", Toast.LENGTH_LONG).show();
            }

            @Override
            public void onStopTrackingTouch(SeekBar seekBar) {
                Toast.makeText(calmActivity.this, "SeekBar in StopTracking", Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    public void clickable(View v){
        Intent in = new Intent(calmActivity.this, SoundTypes.class);
        startActivity(in);
    }
}
