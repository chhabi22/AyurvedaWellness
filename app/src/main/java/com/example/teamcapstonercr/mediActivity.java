...
public class mediActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        player = MediaPlayer.create(mediActivity.this,R.raw.meditate);
        ...
        volume.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onStartTrackingTouch(SeekBar seekBar) {
                Toast.makeText(mediActivity.this,"SeekBar in StartTracking",Toast.LENGTH_LONG).show();
            }

            @Override
            public void onStopTrackingTouch(SeekBar seekBar) {
                Toast.makeText(mediActivity.this,"SeekBar in StopTracking",Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    public void clickable(View v){
        Intent in = new Intent(mediActivity.this, SoundTypes.class);
        startActivity(in);
    }
}
